...
```bash
git clone https://github.com/yourusername/PrescriptionApp.git
cd PrescriptionApp
```
...
npm run dev:prescriptions # Port 4003
npm run dev:pharmacies   # Port 4004
npm run dev:notifications # Port 4005
